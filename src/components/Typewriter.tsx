...
function Typewriter({
    ...
    return (
        <>
            ...
            <span
                className={`${cursorclass } box-border inline-block w-0.5 lg:w-1 ml-0.5 md:ml-1 -mb-1.5 md:-mb-2.5 lg:-mb-3.5  h-7 md:h-9 lg:h-16 animate-typing will-change-transform`}
            ></span>
        </>
    );
}
